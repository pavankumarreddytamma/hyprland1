...
hl.animation({ leaf = "border",        enabled = true,  speed = 5, bezier = "animation3" })
hl.animation({ leaf = "windows",       enabled = true,  speed = 6, bezier = "animation2"})
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 6, bezier = "animation2", style = "slide"})
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 6, bezier = "animation2", style = "slide"})
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 6, bezier = "animation4", style = "slide" })
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 6, bezier = "animation4", style = "slide" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 6, bezier = "animation4", style = "slide" })
