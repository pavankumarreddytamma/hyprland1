...
hl.animation({ leaf = "windows",       enabled = true,  speed = 5, bezier = "animation5"})
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 5, bezier = "animation5", style = "slide"})
hl.animation({ leaf = "windowsOut",    enabled = true,  speed = 5, bezier = "animation5", style = "slide"})
...
hl.animation({ leaf = "layersIn",      enabled = true,  speed = 5, bezier = "animation2", style = "fade" })
hl.animation({ leaf = "layersOut",     enabled = true,  speed = 5, bezier = "animation2", style = "fade" })
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 12, bezier = "animation5", style = "fade" })
hl.animation({ leaf = "workspacesIn",  enabled = true,  speed = 12, bezier = "animation5", style = "fade" })
hl.animation({ leaf = "workspacesOut", enabled = true,  speed = 12, bezier = "animation5", style = "fade" })
